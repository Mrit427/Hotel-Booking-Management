...
const cities = ["Paris", "London", "New York", "Tokyo", "Dubai", "Bangkok"];
...
<h1 className='font-playfair text-2xl md:text-5xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Gateway Destination</h1>
