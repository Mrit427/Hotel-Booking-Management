  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
      <div className='flex flex-col md:flex-row items-center justify-between w-full'>
        <Tittle align='left' tittle='Exclusive Offers' subTittle='Take advantage of our limited-time offers and special packages to enhance your stay and create unforgettable memories.'/>
...
<div>
    <p className='text-2xl font-medium font-playfair'>{item.tittle}</p>
